...
const NowPlaying = () => {
  ...
  return (
    <div className="space-y-2 animate-fade-in">
      <h2 className="text-3xl font-semibold bg-gradient-to-r from-spotify-green to-blue-400 bg-clip-text text-transparent animate-fade-in">
        Your currently playing track on {currentTrack?.device?.name || "Spotify"}
      </h2>
      <div className="bg-background p-4 rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02] border border-border">
